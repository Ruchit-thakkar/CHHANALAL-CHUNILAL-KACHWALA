      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#66635E] font-light mt-1">
            View, contact and manage customer project requests. Total: <strong>{totalCount}</strong>
          </p>
        </div>
                        ...
                        >
                          <div className="flex items-center justify-end space-x-2">
                            ...
                            <button
                              type="button"
                              onClick={() => handleOpenDetail(inquiry)}
                              className="inline-flex items-center space-x-1 px-2.5 py-1.5 bg-[#171717] text-white hover:bg-[#B99A63] text-xs font-semibold uppercase tracking-wider transition-colors"
                            >
              ...
              <div className="p-4 border-t border-[#D9D4CB] flex items-center justify-between text-xs text-[#66635E]">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    disabled={page <= 1}
                    className="p-1.5 border border-[#D9D4CB] bg-white disabled:opacity-30 hover:border-[#171717]"
                  >
